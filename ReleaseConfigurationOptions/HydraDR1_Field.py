...
def FolderAndFileLoc(ParentFolder):
    ...
    SourceName="WALLABY Hydra DR1"
    #   Set the name of the folder where the analysis will be done
    DataReleaseFolder=ParentFolder+"HydraDR1_Analysis/"
    #   Set the name of the folder containing the sources
    SourceFolder=DataReleaseFolder+"WALLABY_Hydra_DR1/"
    ...
    VelFolder=DataReleaseFolder+"Hydra_DR1_VelocityCubes_Mar2022/"
    ...
    MainBaroloFolder=DataReleaseFolder+"BaroloAnalysis/"
...
def FATAnalysisOptions(FolderDict):
    ...
    FATAnalysisFolder=FolderDict['MainFATFolder']+"Mar2022_Analysis/"
...
def FitComparisonOptions(FolderDict):
    ...
    AvgModelReleaseBaseName="Wallaby_Hydra_DR1_KinematicModels_v"+str(ModelVersion)
    ...
    for i in range(nFATFits):
        if i ==0:
            ...
            FATAnalysisFolders[i]=FolderDict['MainFATFolder']+"Mar2022_Analysis/"
            #   Set the name of the base configuration file
            FATConfigFileName[i]="FAT_INPUT_Hydra_DR1.config"
    #   Add in the provenance key values
    SBID="10609,10269,10612,10626"
    SRCVER="SoFiA 2.1.1 (28-Feb-2020)"
    SRCTR="Hydra TR1"
    KINVER="WKAPP v1"
    KINTR="Hydra Kin TR1"
